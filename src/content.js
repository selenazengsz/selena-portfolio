...
export const content = {
  ...
  projects: [
    {
      ...
      caseStudy: {
        ...
        behaviorTest: {
          intro: "The goal is to test whether a customer who usually buys one morning coffee will add a second drink in the afternoon. I compare order and non-order behavior across daypart, product, price, and broad frequency cohorts to see which offer can create that second occasion. I start with an Americano (¥9.9), then test higher-value choices—such as an Americano with an extra espresso shot (¥10.9) or a coconut-water cold brew (¥12.9)—to see whether customers are willing to try new products within a familiar taste profile. These signals guide the next product ladder and audience strategy, which I test to see whether they increase users’ purchase frequency.",
  ...
  contact: {
    ...
    resumeHref: asset("/resume/selena-zeng-resume.pdf"),
